...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202408041534-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  00-opengist.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Aug 04, 2024 15:34 EDT
# @@File             :  00-opengist.sh
# @@Description      :
...
DATABASE_DIR="${DATABASE_DIR_OPENGIST:-/data/db/sqlite}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/httpd/default"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Default predefined variables
DATA_DIR="/data/opengist"   # set data directory
CONF_DIR="/config/opengist" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the containers etc directory
ETC_DIR="/etc/opengist"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the var dir
VAR_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/opengist"       # set the temp dir
RUN_DIR="/run/opengist"       # set scripts pid dir
LOG_DIR="/data/logs/opengist" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR="$DATA_DIR"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVICE_USER="opengist"  # execute command as another user
SERVICE_GROUP="opengist" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
EXEC_CMD_ARGS='--config $ETC_DIR/config.yaml start' # command arguments
...
root_user_name="${OPENGIST_ROOT_USER_NAME:-}" # root user name
root_user_pass="${OPENGIST_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
user_name="${OPENGIST_USER_NAME:-}"      # normal user name
user_pass="${OPENGIST_USER_PASS_WORD:-}" # normal user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
[ -f "/config/env/opengist.script.sh" ] && . "/config/env/opengist.script.sh" # Generated by my dockermgr script
...
CMD_ENV="OG_OPENGIST_HOME=$DATA_DIR OG_DB_FILENAME=../db/sqlite/opengist.db"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  __find_replace "REPLACE_DATABASE_DIR" "$DATABASE_DIR" "$CONF_DIR"
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # define actions
  [ -d "$DATABASE_DIR" ] || mkdir -p "$DATABASE_DIR"
  [ -d "$DATA_DIR/custom" ] || mkdir -p "$DATA_DIR/custom"
  # exit function
  return $exitCode
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# root/admin user info [password/random]
#ENV_ROOT_USER_NAME="${ENV_ROOT_USER_NAME:-$OPENGIST_ROOT_USER_NAME}"   # root user name
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$OPENGIST_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$OPENGIST_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$OPENGIST_USER_PASS_WORD}"             #
